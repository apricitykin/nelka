...
(() => {
  ...
  var MetroModuleFlags, MetroModuleLookupFlags, IndexMetroModuleId, SafeModuleHookAmountBeforeDefer, MetroCacheVersion, MetroCacheKey, MetroModuleFilePathKey, FirstAssetTypeRegisteredKey, assetCacheIndexSymbol;
  var init_constants = __esm({
    "libraries/modules/src/constants.ts"() {
      ...
      FirstAssetTypeRegisteredKey = "__firstTypeRegistered";
  ...
  var CopyIcon, CheckmarkLargeIcon;
  ...
  var constants, tokens, intl, intlModule, Logger, legacy_alerts, alerts, channels, links, clipboard, invites, commands, toasts, messages, NavigationStack, NavigationNative, TextStyleSheet, createStyles, dismissAlerts, openAlert, Flux, FluxDispatcher, assetsRegistry, React2, ReactNative2, ReactJSXRuntime, semver, xxhash64, nobleHashesUtils;
  ...
  var patcher2, logger2, initializeCallbacks, renderCallbacks, isAppInitialized, isAppRendered, unpatchRunApplication, unpatchCreateElement, afterErrorBoundaryPatchable, AppLibrary;
  var init_src4 = __esm({
    "libraries/app/src/index.tsx"() {
      "use strict";
      init_async_to_generator();
  ...
  var patcher3, CustomAssetBrandKey, customAssets, defaultPreferredType, AssetSourceResolver, assetsIndex, AssetsLibrary;
  var init_src5 = __esm({
    "libraries/assets/src/index.ts"() {
      "use strict";
      init_common();
  ...
  var init_shared2 = __esm({
    "libraries/react/src/shared.ts"() {
      "use strict";
      init_src2();
      patcher4 = createPatcherInstance("revenge.react");
    }
  });
  ...
  var import_react_native2, styles2, patched, beforeCallbacks, afterCallbacks, patchCallback, patchJsxRuntimeIfNotPatched, unpatchIfNoListenersLeft, ReactJSXLibrary;
  var init_jsx = __esm({
    "libraries/react/src/jsx.ts"() {
      "use strict";
      init_common();
      ...
      patchJsxRuntimeIfNotPatched = () => {
        ...
        patched = true;
        setTimeout(() => {
          patcher4.instead(ReactJSXRuntime, "jsx", patchCallback, "patchJsxRuntime");
          patcher4.instead(ReactJSXRuntime, "jsxs", patchCallback, "patchJsxRuntime");
        });
      };
      unpatchIfNoListenersLeft = () => {
            ...
            children: [
              {
                ...
                trailing: `${"local"} (${"b6637bd"}${false ? "-dirty" : ""})`
              },
              {
                label: "Discord",
                icon: "Discord",
...
Type: ${asset.type}`,
  ...
  function DeveloperSettingsPage() {
    var { storage, revenge: { assets, modules: modules3 } } = React.useContext(PluginContext2);
    useObservable([
      storage
    ]);
    var navigation = NavigationNative.useNavigation();
          ...
          /* @__PURE__ */ jsxs(TableRowGroup, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(TableRow, {
                ...
                onPress: /* @__PURE__ */ _async_to_generator(function* () {
                  yield FileModule.clearFolder("documents", "./revenge/plugins");
                  BundleUpdaterManager.reload();
                })
              })
            ]
  ...
  function _initialize() {
    ...
    _async_to_generator(function* () {
      ...
      try {
        ...
        var [{ PluginsLibrary: PluginsLibrary2, startCorePlugins: startCorePlugins2, startPluginsMetroModuleSubscriptions: startCorePluginsMetroModuleSubscriptions }, { awaitStorage: awaitStorage2 }, { settings: settings2, pluginsStates: pluginsStates2 }] = yield Promise.all([
